# Kiswahili Shule za Sekondari: Kitabu cha Mwanafunzi, Kidato cha Kwanza — ADT Bundle Reference
...
**Kiswahili Shule za Sekondari: Kitabu cha Mwanafunzi, Kidato cha Kwanza** — Hiki ni kitabu cha mwanafunzi cha somo la Kiswahili kwa Kidato cha Kwanza, kilichoandaliwa na Taasisi ya Elimu Tanzania kwa shule za sekondari nchini Tanzania, na kimeandikwa kwa lugha ya Kiswahili. Kinaelekeza ujifunzaji wa kiwango cha sekondari ya chini kwa kushughulikia mada kama lugha na utamaduni, sarufi, matumizi ya kamusi, kusikiliza, kusoma, kuzungumza na kuandika. Kitabu kinaonesha msisitizo wa kujenga umahiri wa mawasiliano ya Kiswahili fasaha, kuthamini utamaduni wa Mtanzania, na kutumia mbinu shirikishi kama matini, dayolojia, shughuli, mazoezi na matumizi ya TEHAMA.
...
```
Kiswahili-Kidato-cha-Kwanza--2024/
├── adt/                              # THE WEB APP
...
├── Kiswahili-Kidato-cha-Kwanza--2024.db                    # SQLite database (pipeline state)
├── Kiswahili-Kidato-cha-Kwanza--2024.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha Wizara ya Elimu, Sayansi na Teknolojia kwa kitabu cha Kiswahili Shule za Sekondari, Kitabu cha Mwanafunzi, Kidato cha Kwanza; kikiwa na namba 1119, ISBN 978-9987-09-920-7, tarehe ya kuidhinishwa 23 Oktoba 2023, na sahihi ya Kamishna wa Elimu Dkt. Lyabwene M. Mtahabwa.",
  "gl001": "adalala",
  "gl001_def": "gari la abiria linalotoa huduma ya usafiri wa mara kwa mara mijini au kati ya maeneo."
}
```
...
```json
{
  "adalala": {
    "word": "adalala",
    "definition": "gari la abiria linalotoa huduma ya usafiri wa mara kwa mara mijini au kati ya maeneo.",
    "variations": ["daladala","madaladala"],
    "emoji": "🚌"
  }
}
```
...
```json
{
  "title": "Kiswahili Shule za Sekondari: Kitabu cha Mwanafunzi, Kidato cha Kwanza",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw-TZ"
...
| Original PDF | `Kiswahili-Kidato-cha-Kwanza--2024.pdf` |
| Pipeline database | `Kiswahili-Kidato-cha-Kwanza--2024.db` (SQLite) |
